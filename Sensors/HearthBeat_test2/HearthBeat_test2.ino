...
int BPM_0;
int Threshold_0 = 510;            // Determine which Signal to "count as a beat", and which to ingore. usually 550

PulseSensorPlayground pulseSensor_0;

//  Variables sensor_1 sensor

int PulseSensor_1 = 5;        // Pulse Sensor PURPLE WIRE connected to ANALOG PIN 1
int LED_1 = 7;   //  The on-board Arduion LED
int Signal_1;                // holds the incoming raw data. Signal value can range from 0-1024
int BPM_1;
int Threshold_1 = 515;            // Determine which Signal to "count as a beat", and which to ingore. usually 550
